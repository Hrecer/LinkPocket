...
public static class AiProviderCatalog
{
    ...
    [
        new("zai-api", "ai.provider.zaiApi", "Z.ai Coding Plan", AiProtocol.AnthropicMessages,
        ...
        new("bigmodel-api", "ai.provider.bigmodelApi", "BigModel Coding Plan", AiProtocol.AnthropicMessages,
        ...
        new("qwen-alibaba-model-studio-cn", "ai.provider.qwenAlibabaModelStudioCn", "Alibaba Cloud (China)", AiProtocol.AnthropicMessages,
        ...
        new("qwen-alibaba-model-studio-intl", "ai.provider.qwenAlibabaModelStudioIntl", "Alibaba Cloud (Global)", AiProtocol.OpenAiChat,
        ...
        new("opencode-go-chat", "ai.provider.opencodeGoChat", "OpenCode Go (Chat)", AiProtocol.OpenAiChat,
        ...
        new("opencode-go-messages", "ai.provider.opencodeGoMessages", "OpenCode Go (Anthropic)", AiProtocol.AnthropicMessages,
        ...
        new("opencode-go-responses", "ai.provider.opencodeGoResponses", "OpenCode Go (Responses)", AiProtocol.OpenAiResponses,
            "https://opencode.ai/zen/go/v1", IsLocal: false, "https://opencode.ai/auth", null,
            ["gpt-5.6-luna", "grok-4.6"]),
        new("opencode-zen-responses", "ai.provider.opencodeZenResponses", "OpenCode Zen (Responses)", AiProtocol.OpenAiResponses,
        ...
        new("opencode-zen-messages", "ai.provider.opencodeZenMessages", "OpenCode Zen (Anthropic)", AiProtocol.AnthropicMessages,
        ...
        new("opencode-zen-chat", "ai.provider.opencodeZenChat", "OpenCode Zen (Chat)", AiProtocol.OpenAiChat,
            "https://opencode.ai/zen/v1", IsLocal: false, "https://opencode.ai/auth", null,
